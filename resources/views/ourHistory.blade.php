        ...
        <div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
            <div class="card-header p-4 border-bottom border-300 bg-soft">
                <div class="row g-3 justify-content-between align-items-center">
                    <div class="col-12 col-md">
                        <h4 class="text-900 mb-0" data-anchor="data-anchor">Our history</h4>
                    </div>
                </div>
            </div>
            <div class="card-body p-0">
                <div class="p-4 row">
                    ...
                    <div class="mb-0 col-6 justify-content-between">
                        <img class="mb-5 img-fluid" src="../assets/img/pearl-girls/1.jpeg" alt="">
                        <img class="mb-5 img-fluid" src="../assets/img/pearl-girls/3.jpeg" alt="">
                    </div>
                </div>
            </div>
        </div>
